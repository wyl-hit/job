...
from view_emd_start import View_Emd_start
...
class ViewCollectEngine(ServerBase):
    ...
    def __init__(self):
        ...
        super(ViewCollectEngine, self).__init__('view_emd')
    ...
    def engine_start(self, task_id):
        ...
        try:
            engine = View_Emd_start(task_id, current_path, self.mysql_host, self.mysql_db,
            ...
            if task_start_time is not False:
                self.mysql_handle.update_engine_state(
                    task_id, task_start_time, 'view_emd', 0)
            os._exit(0)
